...
internal class SafeWalk
{
	...
	private TileStructure _slbUxvbdQHycDlSLDv7Fp9vzLwcA = ResourceDownloader.GetTile.ByName("Crystal Cave Shallow Water");
		...
		while (true)
		{
			...
			while (true)
			{
				...
				default:
					return;
				case 13u:
					SetTileSafety((int)gameObject._Status._Position._PositionX, (int)gameObject._Status._Position._PositionY, value: true);
				...
				case 0u:
				{
					int num7;
					int num8;
					if (GetTileSafety(jDuaG31Xe8XJ3zd9YVFcuUiYrW._gNqSu0ttbd15HIOb5VM8P14kmgd._PositionX, jDuaG31Xe8XJ3zd9YVFcuUiYrW._gNqSu0ttbd15HIOb5VM8P14kmgd._PositionY))
					{
						num7 = 1353074527;
						num8 = num7;
					}
				...
				case 21u:
				{
					mapStructure = CurrentClient._psKBaUvFAGf2xFOCwHRyUMbhDXG(jDuaG31Xe8XJ3zd9YVFcuUiYrW._gNqSu0ttbd15HIOb5VM8P14kmgd._PositionX, jDuaG31Xe8XJ3zd9YVFcuUiYrW._gNqSu0ttbd15HIOb5VM8P14kmgd._PositionY);
					int num14;
					int num15;
