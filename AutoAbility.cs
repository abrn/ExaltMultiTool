...
internal class AutoAbility
{
	...
	{
		public AutoAbility _7DEudk1H4zeA6HRBegB5UK6RcSYA;
	...
	private readonly List<string> SafeMaps = new List<string>
	{
		"Nexus",
		"Vault",
		"Guild Hall",
	...
	{
		Thread.Sleep(5000);
		PingPacket pingPacket = default(PingPacket);
		while (true)
		{
			int num = 1768634811;
			while (true)
			{
				...
				case 4u:
					pingPacket = (PingPacket)Packet.CreatePacketFromType(PacketType.PING);
					pingPacket._PingHash = -1;
	...
	{
		CurrentMap = SafeMaps.Contains(mapInfo._MapName);
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 4u:
				{
					...
					AoEPacket obj = (AoEPacket)Packet.CreatePacketFromType(PacketType.AOE);
					obj._Color = 0;
					obj._Damage = 0;
					obj._Effect = ConditionEffectEnum.Dead;
					obj._Position = WorldPosData.Initial;
					obj._Radius = 0f;
	...
	public void OnAoEPacket(AoEAckPacket aoeAck)
	{
	...
	public void _w523XOeezIrQZ8eMr8WGCIMyQ8N(PongPacket pong)
	{
		if (pong._PingHash == -1)
		{
			goto IL_000c;
		...
		IL_0011:
		int num4 = default(int);
		ParseXML parseXml = default(ParseXML);
		...
		while (true)
		{
			...
			case 0u:
				parseXml = ResourceDownloader._3ndzvDGHhvqls1BD8vzizSQBDdI.ById((ushort)num7);
				num = 721113957;
				continue;
			case 33u:
				goto IL_01fa;
			...
			case 63u:
				return;
			case 65u:
				_PRhnVDn3ZtczdfIW02GMGzedebA(parseXml, iBSqBdwNTiXSzhZbDhEFMC0Gc);
				num = 1575038679;
				continue;
			case 6u:
				return;
	...
	private void _bgSVetCGPR3zNWnEkr4cuYlGGJg(ParseXML item, int time, WorldPosData position = null, byte useType = 1)
	{
		if (position == null)
		{
			goto IL_0006;
		...
		while (true)
		{
			...
			case 6u:
				...
				continue;
			case 4u:
				useItemPacket._if0d81H88w2JolCC4orFfcsIICeA = useType;
	...
	private void _PRhnVDn3ZtczdfIW02GMGzedebA(ParseXML item, int time, bool requireHeal = false)
	{
	...
	private void _tExbGVr38Q9WmU2JSuGsUJ2EITe(int Time)
	{
		...
		while (true)
		{
			...
			default:
				return;
			case 22u:
				allyShootPacket._5oFaCQNi71DUAwr2GsRcpozHzAC = playerShootPacket._5oFaCQNi71DUAwr2GsRcpozHzAC;
			...
			case 27u:
				return;
			case 6u:
				playerShootPacket._hjRbCZIgEE6lGZJqDLlpYixCdUT = 0f;
				num = ((int)num3 * -545284984) ^ -564965075;
				continue;
			case 14u:
				allyShootPacket._isVjytSCPjaQXfnhSgmbShfAEYC = playerShootPacket._isVjytSCPjaQXfnhSgmbShfAEYC;
				num = (int)(num3 * 2097832356) ^ -737268968;
				continue;
			case 17u:
				return;
			case 20u:
				allyShootPacket._hjRbCZIgEE6lGZJqDLlpYixCdUT = playerShootPacket._hjRbCZIgEE6lGZJqDLlpYixCdUT;
			...
			case 1u:
				...
				continue;
			case 18u:
				parseXml = ResourceDownloader._3ndzvDGHhvqls1BD8vzizSQBDdI.ById((ushort)num4);
				num = 1980099783;
				continue;
			case 28u:
			...
			case 19u:
				return;
			case 10u:
				playerShootPacket = (PlayerShootPacket)Packet.CreatePacketFromType(PacketType.PLAYERSHOOT);
			...
			case 16u:
				...
				continue;
			case 26u:
				allyShootPacket = (AllyShootPacket)Packet.CreatePacketFromType(PacketType.ALLYSHOOT);
			...
			IL_03a7:
			int num13;
			if (num9 < parseXml._NumProjectiles)
			{
				num = 1956691123;
				num13 = num;
			}
	...
	private void _1ewKC7M4NL9N81VglwFrDKTJTfK(ParseXML item, int time, double projSpeed, double maxDist, WorldPosData playerPos)
	{
		maxDist *= maxDist;
						...
						using (Dictionary<int, PlayerData>.ValueCollection.Enumerator enumerator = _50w8wVuv8bL5nhKaR2EHxjrTamB._Aq9hW2NyDqEkITmxzYm6OCQLaDB.Values.GetEnumerator())
						{
							while (true)
							{
								...
								while (true)
								{
									...
									case 14u:
										num10 = playerPos.GetDistance(current3._Position);
										num65 = 1753802518;
										continue;
									case 32u:
										break;
									...
									case 27u:
										worldPosData = new WorldPosData(current3._Position._PositionX, current3._Position._PositionY);
										num65 = 21607826;
										continue;
									case 0u:
									{
						...
						using (Dictionary<int, PlayerData>.ValueCollection.Enumerator enumerator = _50w8wVuv8bL5nhKaR2EHxjrTamB._Aq9hW2NyDqEkITmxzYm6OCQLaDB.Values.GetEnumerator())
						{
							while (true)
							{
								...
								while (true)
								{
									...
									case 12u:
										worldPosData = new WorldPosData(current2._Position._PositionX, current2._Position._PositionY);
										num37 = 1584080509;
										continue;
									case 10u:
									{
									...
									case 14u:
										num10 = playerPos.GetDistance(current2._Position);
						...
						using (Dictionary<int, PlayerData>.ValueCollection.Enumerator enumerator = _50w8wVuv8bL5nhKaR2EHxjrTamB._Aq9hW2NyDqEkITmxzYm6OCQLaDB.Values.GetEnumerator())
						{
							while (true)
							{
								...
								while (true)
								{
									...
									case 23u:
										worldPosData = new WorldPosData(current._Position._PositionX, current._Position._PositionY);
										num3 = 66855471;
										continue;
									case 22u:
									{
									...
									case 13u:
									{
										num10 = playerPos.GetDistance(current._Position);
										int num19;
										int num20;
										if (num10 > maxDist)
										{
	...
	private int _XGY0dKXAFuLaWx4T7tQ9XLiiZ54(PlayerData target, ref _q5bAS2GGlyEXggyfH1UYW81UmnS P_1)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
					int num5;
					if (!(target._Position.GetDistance(current._Position) <= (double)P_1._TQs3I5HnEqElZoiO4Dsa88IEj3u))
					{
						num2 = 885423107;
						num5 = num2;
					}
