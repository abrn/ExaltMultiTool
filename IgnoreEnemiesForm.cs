...
internal class IgnoreEnemiesForm : Form
{
	[Serializable]
	[CompilerGenerated]
	private sealed class _jUWaQ5L2pqzJuXIYrRVijuF7a8D
	{
		...
		{
			return ResourceDownloader._VPArsrlUa0uEsW6OxAYV9WHJAMK.ById((ushort)id);
		}
	...
	{
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(IgnoreEnemiesForm));
