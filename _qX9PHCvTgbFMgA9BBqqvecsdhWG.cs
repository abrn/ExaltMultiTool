...
internal class _qX9PHCvTgbFMgA9BBqqvecsdhWG : UserControl
{
	...
	public _qX9PHCvTgbFMgA9BBqqvecsdhWG()
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 17u:
					...
					continue;
				case 44u:
					componentResourceManager = new ComponentResourceManager(typeof(_qX9PHCvTgbFMgA9BBqqvecsdhWG));
