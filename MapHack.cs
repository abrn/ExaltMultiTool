...
internal class MapHack
{
	...
	private static void _a3EFUCdw6YgGgD3X2gxdrKBlSIf()
	{
		...
		default:
		{
			IDictionaryEnumerator enumerator = new ResourceManager(typeof(Resources)).GetResourceSet(CultureInfo.CurrentUICulture, createIfNotExists: true, tryParents: true).GetEnumerator();
			try
			{
