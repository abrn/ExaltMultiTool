...
internal class AutoNexus
{
	...
	private void SubtractDamage(int damage, string source = "Unknown")
	{
		...
		while (true)
		{
			...
			default:
				return;
			case 6u:
				num3 = _fEgmKLJBX4eDyOg6a5xshzKbnJN * 100 / _Client._PlayerData._fBkfBLhhMp7FH6BVjSag96CvhnT;
				num = (int)(num2 * 1235508773) ^ -233770313;
				continue;
			case 3u:
				_Client.SendToClient(Reconnect());
				num = ((int)num2 * -1259991153) ^ 0x65D59ADB;
				continue;
			case 1u:
				goto IL_0092;
			case 0u:
				_Client.SendChatNotification("AutoNexus", $"AutoNexused at {num3}% HP\nSource: {damage} {source}");
				num = ((int)num2 * -1230663376) ^ -2096333964;
				continue;
			case 5u:
				_Client.SendToServer((EscapePacket)Packet.CreatePacketFromType(PacketType.ESCAPE));
	...
	private static ReconnectPacket Reconnect()
	{
	...
	{
		_oV73NEwk247WZa6wM3sxIJwPEei = _SafeMaps.Contains(mapInfo._MapName);
		...
		_InOceanTrench = mapInfo._MapName == "Ocean Trench";
	}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 3u:
				{
					...
					int num4;
					if (current._ObjectId != _Client._UqAoky1lauc0gYPMEYUcYfMlJkC)
					{
						num = -604683750;
						num4 = num;
					}
	...
	public void _kcBjTzBYfTPCpKNctSQjw45y1mb(NewTickPacket newTick)
	{
		...
		while (true)
		{
			...
			case 2u:
				_fEgmKLJBX4eDyOg6a5xshzKbnJN = _Client._PlayerData._fBkfBLhhMp7FH6BVjSag96CvhnT;
			...
			case 4u:
			{
				int num8;
				int num9;
				if (_fEgmKLJBX4eDyOg6a5xshzKbnJN > _Client._PlayerData._fBkfBLhhMp7FH6BVjSag96CvhnT)
				{
					num8 = -1566041661;
					num9 = num8;
				}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				data.Add(new StatData
				{
					...
					_StatValue = _Client._PlayerData._fBkfBLhhMp7FH6BVjSag96CvhnT,
					_StringStatValue = string.Empty
				});
	...
	{
		int num = _Client._ThXZKkD7eTKsvHaetPD5l7lo3ld;
		while (true)
		{
			int num2 = 477826601;
			while (true)
			{
				...
				case 6u:
					break;
				case 2u:
					_NVu1TmQ2nvgEoFJidtvcpeWuIxP(move._Time, num, 0, move._NewPosition);
				...
				case 0u:
					...
					continue;
				case 3u:
					_NVu1TmQ2nvgEoFJidtvcpeWuIxP(move._Time, num, num - _tnzATORRz69PD9QNslfqhszFO2M, move._NewPosition);
					num2 = 777135326;
					continue;
				case 1u:
				{
	...
	{
		if (notification._fn2CRnBpjyTWHR9K8SU4iOwhDtK != _Client._UqAoky1lauc0gYPMEYUcYfMlJkC)
		{
			goto IL_0016;
		}
		goto IL_01cb;
		...
		while (true)
		{
			...
			IL_0268:
			int num10;
			if (result + _fEgmKLJBX4eDyOg6a5xshzKbnJN > _Client._PlayerData._fBkfBLhhMp7FH6BVjSag96CvhnT)
			{
				num = 530151988;
				num10 = num;
			}
	...
	public void _f8Cv4bMnfjjwRWfQwllvwFZDPuI(AoEAckPacket aoeAck)
	{
		...
		goto IL_0042;
		IL_0042:
		_Position = aoeAck._ObXrbtVZcdprxclR2Ggz9jKwlp;
			...
			while (true)
			{
				...
				while (true)
				{
					...
					case 5u:
					{
						int num5;
						int num6;
						if (_Position.GetAngle(current._hZZqGJ97TiaLFTbiTFhvTTSGkIb) >= (double)current._I9LOulXQ6dWoDQOn1L5GkchnJUC)
						{
							num5 = -169044016;
							num6 = num5;
						}
					...
					case 9u:
						_CLRtscLVGwgyeHHILRfayjUB8iu(_EKcpayCwlxsQrEGbJ0bBOTfv5bJ(current._C3mvDTxTLKOCwcaeO4BKeVV1ydo, _Client._PlayerData._DKXdZpvHo34S5ZnQVXvzkRCVbXr, current._l0mdLwT0Lqvn0oV26TZ8wa7mjTf), "AoE damage (" + text + ")");
						num3 = -782191089;
						continue;
					case 8u:
						goto end_IL_005a;
	...
	public void _W4ULDsCzGjGES6SCKBD4lp5hvRd(GroundDamagePacket groundDamage)
	{
		...
		goto IL_0102;
		IL_0102:
		MapStructure mapStructure = _Client._psKBaUvFAGf2xFOCwHRyUMbhDXG(groundDamage._Position);
		int num = 496896558;
		goto IL_0010;
		IL_0010:
		while (true)
		{
			...
			case 6u:
				...
				continue;
			case 2u:
				_Client.SendChatNotification("AutoNexus", "Took ground damage from an unknown source, autonexus may not be fully functional!");
				return;
			case 0u:
	...
	public void _gHqtNcWyCVVFxHdmeuer3tJSw4p(PlayerHitPacket playerHit)
	{
		...
		while (true)
		{
			...
			case 15u:
				...
				continue;
			case 12u:
				_Client.SendChatNotification("AutoNexus", "Took projectile damage from an unknown source, autonexus may not be fully functional!");
			...
			case 9u:
				...
				continue;
			case 11u:
				amount = _EKcpayCwlxsQrEGbJ0bBOTfv5bJ((ushort)projectile.Damage, _Client._PlayerData._DKXdZpvHo34S5ZnQVXvzkRCVbXr, armorPierce);
	...
	private int _EKcpayCwlxsQrEGbJ0bBOTfv5bJ(ushort originalDamage, int playerDefense, bool armorPierce)
	{
		...
		while (true)
		{
			...
			case 5u:
			{
				int num7;
				int num8;
				if (_Client._PlayerData._aSSHSWAWCnEmRnN8M0J6kmLwnIn())
				{
					num7 = 1172720174;
					num8 = num7;
				}
			...
			case 4u:
			{
				int num5;
				int num6;
				if (!_Client._PlayerData._9zLynim4HlmFvQv3AqAl2vIblhc())
				{
					num5 = 2129642284;
					num6 = num5;
				}
			...
			IL_01f6:
			int num9;
			if (_Client._PlayerData._tkfj3gYuI6ubFC5MTh0aCabHAgTA())
			{
				num2 = -276925452;
				num9 = num2;
			}
			...
			IL_0133:
			int num10;
			if (_Client._PlayerData._uRofpGAWTai1pFW78nU1atwjVxo())
			{
				num2 = -1346622045;
				num10 = num2;
			}
			...
			IL_00d1:
			int num11;
			if (_Client._PlayerData._FtmAQausrRLeBhCy0y3hoFCWisb())
			{
				num2 = -315423902;
				num11 = num2;
			}
			...
			IL_0159:
			int num12;
			if (_Client._PlayerData._quNJ1T7LQlmCLS88KJxY2t10VQA())
			{
				num2 = -245267439;
				num12 = num2;
			}
	...
	private void _NVu1TmQ2nvgEoFJidtvcpeWuIxP(int moveTime, int time, int diff, WorldPosData whereabouts)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 2u:
					SubtractDamage(fEgmKLJBX4eDyOg6a5xshzKbnJN - _fEgmKLJBX4eDyOg6a5xshzKbnJN, "(Health drain)");
	...
	private void _AuJ9LotJSsltyge55rNhCJwiERG(int moveTime, int time, WorldPosData whereabouts)
	{
		...
		while (true)
		{
			...
			IL_00d0:
			int num9;
			if (_Client._PlayerData._v6scruPI8GbKsVXu2rpqDMycX0Q > _8bQcVNrY4sOsCzDreFoeakMtpBK)
			{
				num = -596320299;
				num9 = num;
			}
			...
			IL_0059:
			int num10;
			if (_Client._PlayerData._YLm5uWwBjPzhLKwhlH4ENYMtq8u())
			{
				num = -537900654;
				num10 = num;
			}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 14u:
					...
					continue;
				case 4u:
					_Client._xlRUy72uPQ98Hy5AvYCNwBvoQ4K(num10);
				...
				{
					int num13;
					if (num10 < _Client.PotionSlots.Length)
					{
						num = 1198436290;
						num13 = num;
					}
				...
				{
					int num14;
					if (!TryUsePotion(_Client._PlayerData.Inventory[num6]))
					{
						num = 1545852683;
						num14 = num;
					}
				...
				case 11u:
				{
					int num11;
					int num12;
					if (TryUsePotion(potionInfo.Type))
					{
						num11 = -639280571;
						num12 = num11;
					}
				...
				case 5u:
					slotObjectData = new SlotObjectData(_Client._UqAoky1lauc0gYPMEYUcYfMlJkC, 1000000 + num10, potionInfo.Type);
					num = (int)(num2 * 120484148) ^ -1905926061;
					continue;
				case 10u:
					slotObjectData = new SlotObjectData(_Client._UqAoky1lauc0gYPMEYUcYfMlJkC, num6, _Client._PlayerData.Inventory[num6]);
					num = (int)(num2 * 2026954862) ^ -1196184572;
					continue;
				case 7u:
					potionInfo = _Client.PotionSlots[num10];
					num = 79909149;
					continue;
				case 3u:
				...
				{
					int num7;
					if (num6 < _Client._PlayerData.Inventory.Length)
					{
						num = 86852384;
						num7 = num;
					}
	...
	private bool TryUsePotion(int id)
	{
		if (id == -1)
		{
			goto IL_0004;
	...
	private void _MZEpjczfvKiLuBC5dtTeu4eiUrI(int diff)
	{
		...
		double num2 = 2.0 * (1.0 + 0.12 * (double)_Client._PlayerData._P6tDEyGoXHV3WltSPRoAkw3XvUe);
		...
		while (true)
		{
			...
			while (true)
			{
				...
				default:
					return;
				case 11u:
					num7 = ((_Client._PlayerData._3TdWQMIfFRLyOCb0Tb6TO3SonPc == 0) ? 1 : 0);
					goto IL_009e;
				case 9u:
				...
				case 6u:
					return;
					IL_009e:
					if (!_Client._PlayerData._YLm5uWwBjPzhLKwhlH4ENYMtq8u() && !_Client._PlayerData._318BaWhp3KqQPFQI19qagassWIP())
					{
						_nZ4umDhXWmp8bGVywQUwURRhqK += num2 * num;
						if (_Client._PlayerData._Z9kQZ9yr8r0HU8Vt3nIBcujjeHP())
						{
							_nZ4umDhXWmp8bGVywQUwURRhqK += 20.0 * num;
						}
					}
					else if (_Client._PlayerData._318BaWhp3KqQPFQI19qagassWIP())
					{
						_nZ4umDhXWmp8bGVywQUwURRhqK -= 20.0 * num;
					}
					if (num7 != 0)
		...
		while (true)
		{
			...
			while (true)
			{
				...
				default:
					return;
				case 3u:
					_wpv3L2x9SVwVG8oTXkB9xlrWfYf = (int)((double)Settings.Default.AutoNexusPercentageThreshold * 0.01 * (double)_Client._PlayerData._fBkfBLhhMp7FH6BVjSag96CvhnT);
					num = ((int)num2 * -2123389298) ^ -767587602;
					continue;
				case 2u:
					_8bQcVNrY4sOsCzDreFoeakMtpBK = (int)((double)Settings.Default.AutoNexusDrinkThreshold * 0.01 * (double)_Client._PlayerData._fBkfBLhhMp7FH6BVjSag96CvhnT);
	...
	private bool _zPOUViNkt7ARkkvn46oJQqXIDxd()
	{
		...
		while (true)
		{
			...
			IL_00e8:
			int num8;
			if (_Client._PlayerData._v6scruPI8GbKsVXu2rpqDMycX0Q < _wpv3L2x9SVwVG8oTXkB9xlrWfYf)
			{
				num = -519666422;
				num8 = num;
			}
	...
	public void OnPlayerText(PlayerTextPacket playerText)
	{
		...
		while (true)
		{
			...
			case 6u:
				return;
			case 1u:
				_fEgmKLJBX4eDyOg6a5xshzKbnJN = _Client._PlayerData._v6scruPI8GbKsVXu2rpqDMycX0Q;
				return;
			case 3u:
				return;
			case 5u:
