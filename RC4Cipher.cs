...
internal class RC4Cipher {
	private static readonly int _BlockSize = 256;
	...
	{
		_Key = key;
		_g0jwkGBqJwqQii6TVP2camNvrDJ(_Key);
	}
			...
			while (true) {
				...
				switch ((num2 = (uint) num ^ 0xC92F4428u) % 4u) {
					...
					default:
						return;
					case 1u:
						_Key = _heBGzcYICjJ66XC3tq6ybNspg3b(hexString);
			...
			while (true) {
				...
				switch ((num4 = (uint) num2 ^ 0xED446670u) % 9u) {
					...
					case 3u:
						...
						continue;
					case 1u:
						_o0O3vwbrhWRjD7Rf8KFFYkBLpJw[_9M0M4FsgDZOfxwDc9Ew4YKgGimY] =
							_o0O3vwbrhWRjD7Rf8KFFYkBLpJw[_6fpz4HWazbE78JNyAvFH5JVDQsF];
						num2 = ((int) num4 * -1126495955) ^ -665018238;
						continue;
					case 6u:
						_9M0M4FsgDZOfxwDc9Ew4YKgGimY = (_9M0M4FsgDZOfxwDc9Ew4YKgGimY + 1) & 0xFF;
						_6fpz4HWazbE78JNyAvFH5JVDQsF = (_o0O3vwbrhWRjD7Rf8KFFYkBLpJw[_9M0M4FsgDZOfxwDc9Ew4YKgGimY] +
						                                _6fpz4HWazbE78JNyAvFH5JVDQsF) & 0xFF;
						num2 = -197455258;
						continue;
					case 2u:
					...
					case 5u:
						...
						continue;
					case 8u:
						output[num + outOff] = (byte) (input[num + inOff] ^
						                               _o0O3vwbrhWRjD7Rf8KFFYkBLpJw[
							                               (_o0O3vwbrhWRjD7Rf8KFFYkBLpJw[_9M0M4FsgDZOfxwDc9Ew4YKgGimY] +
							                                _o0O3vwbrhWRjD7Rf8KFFYkBLpJw[_6fpz4HWazbE78JNyAvFH5JVDQsF]
							                               ) & 0xFF]);
			...
			while (true) {
				...
				switch ((num2 = (uint) num ^ 0xA2E217BBu) % 20u) {
					...
					case 5u:
						...
						continue;
					case 0u:
						_o0O3vwbrhWRjD7Rf8KFFYkBLpJw = new byte[_BlockSize];
		...
		while (true) {
			...
			switch ((num3 = (uint) num2 ^ 0x38AF9571u) % 8u) {
				...
				case 7u:
					...
					continue;
				case 0u:
					num4 = Convert.ToInt32(new StringBuilder(2).Append(array2[num]).Append(array2[num + 1]).ToString(),
						16);
					num2 = 431827678;
					continue;
				default:
