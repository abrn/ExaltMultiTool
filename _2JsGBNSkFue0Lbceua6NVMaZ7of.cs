...
internal class _2JsGBNSkFue0Lbceua6NVMaZ7of
{
	...
	private int _tnzATORRz69PD9QNslfqhszFO2M = -1;

	private int _qHZZzoli0IgcIAn5PLmFGLabsyC;

	public _2JsGBNSkFue0Lbceua6NVMaZ7of(_PlferqYaObizDfc28C5jdKSLGq5 client)
	{
		while (true)
		{
			int num = 383290231;
			...
			{
				uint num2;
				switch ((num2 = (uint)num ^ 0x52728E26u) % 4u)
				{
				case 3u:
					break;
				default:
				...
				case 1u:
					...
					num = ((int)num2 * -1636197732) ^ -1315644450;
					continue;
				case 0u:
					Projectile.Initialize();
					num = (int)(num2 * 1090117553) ^ -1876487464;
					continue;
				case 2u:
					return;
				}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 1u:
					...
					_50w8wVuv8bL5nhKaR2EHxjrTamB._2CIHnoEa49dfPXyqt9nkkBlUcQf = new _TmFas5PEXYMVmPQTpu3tg3XuoTo[mapInfo._6HwO75kWNssUCje1MLwKd3pGXmk * mapInfo._CmwC8GuQ56hi7QXOmmQpFukQ49j];
				...
				case 3u:
					...
					continue;
				case 0u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._naDcMlPfaanTh6qrJ3cOuO4HNwz.Clear();
					_50w8wVuv8bL5nhKaR2EHxjrTamB._Aq9hW2NyDqEkITmxzYm6OCQLaDB.Clear();
				...
				case 6u:
					...
					continue;
				case 5u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._VPArsrlUa0uEsW6OxAYV9WHJAMK.Clear();
					num = (int)((num2 * 1554937275) ^ 0x34B292F1);
					continue;
				default:
				{
					using (Dictionary<int, Dictionary<int, Projectile>>.Enumerator enumerator = _50w8wVuv8bL5nhKaR2EHxjrTamB._N5GofMpQbwbVNiYLmSHHRmpmKhg.GetEnumerator())
					{
						while (true)
						{
							int num3;
					...
					_50w8wVuv8bL5nhKaR2EHxjrTamB._N5GofMpQbwbVNiYLmSHHRmpmKhg.Clear();
					return;
				}
				}
				break;
	...
	public void _YZBUA9d1NRteoNEIGwJjUbTmHLC()
	{
		...
		while (true)
		{
			...
			{
				uint num2;
				switch ((num2 = (uint)num ^ 0xA2220F7Eu) % 3u)
				{
				case 0u:
					break;
				default:
				...
				num = ((int)num2 * -512324760) ^ 0x1ADE68F9;
			}
		}
	}
	...
	{
		Thread.Sleep(500);
		_50w8wVuv8bL5nhKaR2EHxjrTamB.sendChatNotification("RealmStock", "Connected to MultiTool Proxy!");
	}
	...
	public void _emTnZmGyChlXH4IDm60126G1Snf(UpdatePacket update)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 13u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._2CIHnoEa49dfPXyqt9nkkBlUcQf[tileObject._PositionX * _qHZZzoli0IgcIAn5PLmFGLabsyC + tileObject._PositionY] = new _TmFas5PEXYMVmPQTpu3tg3XuoTo(ResourceDownloader._2CIHnoEa49dfPXyqt9nkkBlUcQf._EOUVvVncv0meCCDQkGXOyUOLU5F(tileObject._TileType), tileObject._PositionX, tileObject._PositionY, tileObject._TileType);
				...
				case 20u:
					...
					continue;
				case 18u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._W6bpBrAw6dPSILcVRK394JGD7tC = jI4Bueou7dItYp5S7QML5vyC6Rc;
				...
				case 19u:
					...
					goto case 1u;
				case 6u:
					if (jI4Bueou7dItYp5S7QML5vyC6Rc._fn2CRnBpjyTWHR9K8SU4iOwhDtK == _50w8wVuv8bL5nhKaR2EHxjrTamB._UqAoky1lauc0gYPMEYUcYfMlJkC)
					{
				...
				case 1u:
					...
					while (true)
					{
						...
						case 5u:
							goto IL_056e;
						case 13u:
							_50w8wVuv8bL5nhKaR2EHxjrTamB._VPArsrlUa0uEsW6OxAYV9WHJAMK.Remove(key);
						...
						case 3u:
							goto IL_05d9;
						case 7u:
							_50w8wVuv8bL5nhKaR2EHxjrTamB._Aq9hW2NyDqEkITmxzYm6OCQLaDB.Remove(key);
						...
						case 1u:
							goto IL_0644;
						case 6u:
							_50w8wVuv8bL5nhKaR2EHxjrTamB._naDcMlPfaanTh6qrJ3cOuO4HNwz.Remove(key);
						...
						IL_0644:
						int num14;
						if (_50w8wVuv8bL5nhKaR2EHxjrTamB._VPArsrlUa0uEsW6OxAYV9WHJAMK.ContainsKey(key))
						{
							num9 = 453787784;
							num14 = num9;
						}
						...
						int num16;
						if (_50w8wVuv8bL5nhKaR2EHxjrTamB._Aq9hW2NyDqEkITmxzYm6OCQLaDB.ContainsKey(key))
						{
							num9 = 1378625138;
							num16 = num9;
						}
						...
						IL_05d9:
						int num17;
						if (_50w8wVuv8bL5nhKaR2EHxjrTamB._naDcMlPfaanTh6qrJ3cOuO4HNwz.ContainsKey(key))
						{
							num9 = 1286034947;
							num17 = num9;
						}
	...
	private void _vK3Un4l0XFJiyoE34BNH9fitpDc(List<StatData> data)
	{
		PotionInfo potionInfo = _50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm.ElementAt(0);
		data.Add(new StatData
		{
			_StatType = StatType._SbG99DT4Q20EiNjBNzIakE3Jugt,
		...
		while (true)
		{
			...
			{
				uint num2;
				switch ((num2 = (uint)num ^ 0x30ADAA5u) % 3u)
				{
				case 0u:
					break;
				default:
				...
				break;
				IL_0070:
				potionInfo = _50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm.ElementAt(1);
				data.Add(new StatData
				{
					_StatType = StatType._dSvzyTzpt52eGfhdOI4AAtAyfTp,
					_StatValue = potionInfo.Type,
					_MagicByte = potionInfo.Quantity,
					_StringStatValue = string.Empty
				});
				potionInfo = _50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm.ElementAt(2);
				data.Add(new StatData
				{
					_StatType = StatType._6McE94HGZ7Fc2g6W7ikQ3Ucw6Gh,
					_StatValue = potionInfo.Type,
					_MagicByte = potionInfo.Quantity,
					_StringStatValue = string.Empty
				});
				num = ((int)num2 * -931563862) ^ -639510956;
			}
		}
	}

	private PotionInfo[] _l9gQO8XQ1GsKFJroGbgdgagiQVO(IEnumerable<StatData> statusData)
	{
		...
		try
		{
			...
			while (true)
			{
				...
				while (true)
				{
					...
					{
						int num5;
						if (StatType._BEkCFGP4TWapPej8J0mAjEGM8LD(current._StatType, StatType._dSvzyTzpt52eGfhdOI4AAtAyfTp))
						{
							num = -170153674;
							num5 = num;
						}
					...
					{
						int num6;
						if (StatType._BEkCFGP4TWapPej8J0mAjEGM8LD(current._StatType, StatType._6McE94HGZ7Fc2g6W7ikQ3Ucw6Gh))
						{
							num = -28454293;
							num6 = num;
						}
					...
					case 2u:
					{
						current = enumerator.Current;
						int num4;
						if (!StatType._BEkCFGP4TWapPej8J0mAjEGM8LD(current._StatType, StatType._SbG99DT4Q20EiNjBNzIakE3Jugt))
						{
							num = -2099395234;
							num4 = num;
						}
	...
	public void _kcBjTzBYfTPCpKNctSQjw45y1mb(NewTickPacket newTick)
	{
		...
		if (_50w8wVuv8bL5nhKaR2EHxjrTamB._QtBizqH8aHz2ixkvUsA6VqqwHGF == -1)
		{
			return;
		}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 1u:
				{
					int num12;
					int num13;
					if (Environment.TickCount - _50w8wVuv8bL5nhKaR2EHxjrTamB._QtBizqH8aHz2ixkvUsA6VqqwHGF <= 1000)
					{
						num12 = -2097939861;
						num13 = num12;
					}
				...
				case 3u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._QtBizqH8aHz2ixkvUsA6VqqwHGF = -1;
						...
						while (true)
						{
							...
							while (true)
							{
								...
								default:
									goto end_IL_0189;
								case 1u:
									_vK3Un4l0XFJiyoE34BNH9fitpDc(current2._Stats);
									return;
								case 0u:
								{
									int num9;
	...
	public void _tX4Fl2mBYL4XNqNEIW0OPnopM9i(_WCTbeWogZHoPyDnxles484v2oK move)
	{
		...
		while (true)
		{
			...
			{
				uint num2;
				switch ((num2 = (uint)num ^ 0x7965743Au) % 3u)
				{
				case 0u:
					break;
				default:
				...
				break;
				IL_003a:
				_50w8wVuv8bL5nhKaR2EHxjrTamB._W6bpBrAw6dPSILcVRK394JGD7tC._FLMczMOk4gNIJMbSsAnIDIvYlDP = move._r0866iEhjgniNmmLz9ygFmfaWPA;
				num = ((int)num2 * -1851588854) ^ -364178779;
			}
		}
	}
	...
	public void _D9IW2BuNJJegmeKKBdYfjD1lrHd(_3x8iFljfoYzeYeVnM3YLGbk4Cbc enemyShoot)
	{
		...
		goto IL_031c;
		IL_031c:
		PlayerData jI4Bueou7dItYp5S7QML5vyC6Rc = _50w8wVuv8bL5nhKaR2EHxjrTamB._VPArsrlUa0uEsW6OxAYV9WHJAMK[enemyShoot._qL8Qk0RJEu4lcCGcJpKfz1Fn8tb];
		int num = 1348272505;
		goto IL_0020;
		IL_0020:
		...
		while (true)
		{
			...
			case 14u:
				...
				continue;
			case 17u:
				structure = dictionary2[enemyShoot._XkoPVTLGPjjI2mDSH9xlH0vbBOe];
				num = 1907331609;
				continue;
			case 9u:
				Program._et8c2Heqb7KWtXL1gFN1nBBGIVP("client", $"Unable to find enemy type in map, enemytype: {jI4Bueou7dItYp5S7QML5vyC6Rc._y2nCjecGeYsmqDEzaplcuBvYtN7} ({jI4Bueou7dItYp5S7QML5vyC6Rc._dzjzSFbtOGDAQRisUTP7vokTlVD})");
				num = (int)((num2 * 1353711768) ^ 0x42288EDB);
				continue;
			case 15u:
				value.OwnerId = enemyShoot._qL8Qk0RJEu4lcCGcJpKfz1Fn8tb;
				value.Damage = enemyShoot._C3mvDTxTLKOCwcaeO4BKeVV1ydo;
				value.ProjectileType = enemyShoot._XkoPVTLGPjjI2mDSH9xlH0vbBOe;
			...
			case 19u:
				...
				continue;
			case 27u:
				b = (byte)((enemyShoot._isVjytSCPjaQXfnhSgmbShfAEYC + num9) % 256);
				num = 1965628637;
				continue;
			case 13u:
			{
				int num5;
				int num6;
				if (dictionary2.ContainsKey(enemyShoot._XkoPVTLGPjjI2mDSH9xlH0vbBOe))
				{
					num5 = 607588613;
					num6 = num5;
				}
			...
			case 24u:
				...
				continue;
			case 1u:
				dictionary = _50w8wVuv8bL5nhKaR2EHxjrTamB._N5GofMpQbwbVNiYLmSHHRmpmKhg[enemyShoot._qL8Qk0RJEu4lcCGcJpKfz1Fn8tb];
				num = 443892866;
				continue;
			case 20u:
				goto IL_031c;
			case 3u:
				...
				continue;
			case 7u:
				Program._et8c2Heqb7KWtXL1gFN1nBBGIVP("client", $"Unable to find enemy projectile type in map, enemytype: {jI4Bueou7dItYp5S7QML5vyC6Rc._y2nCjecGeYsmqDEzaplcuBvYtN7} ({jI4Bueou7dItYp5S7QML5vyC6Rc._dzjzSFbtOGDAQRisUTP7vokTlVD})");
				num = (int)((num2 * 1698108007) ^ 0x13762240);
				continue;
			case 4u:
				goto IL_0390;
			case 12u:
				_50w8wVuv8bL5nhKaR2EHxjrTamB._N5GofMpQbwbVNiYLmSHHRmpmKhg.Add(enemyShoot._qL8Qk0RJEu4lcCGcJpKfz1Fn8tb, dictionary);
			...
			IL_0390:
			int num10;
			if (!_50w8wVuv8bL5nhKaR2EHxjrTamB._N5GofMpQbwbVNiYLmSHHRmpmKhg.ContainsKey(enemyShoot._qL8Qk0RJEu4lcCGcJpKfz1Fn8tb))
			{
				num = 342794149;
				num10 = num;
			}
	...
	public void _n0JAIElTXMoPeH6KBaRBdWaaWov(_lRcj7b0Xq67vwsbjqopaQvHrEiC invResult)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				{
					int num13;
					if (invResult._sEYqjeelWD912mJ6sF5MhQRyISf._SlotId >= 1000000)
					{
						num = -420565490;
						num13 = num;
					}
				...
				case 12u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._sEYqjeelWD912mJ6sF5MhQRyISf._SlotId - 1000000].Quantity = 0;
					num = (int)(num2 * 1743529491) ^ -1692260871;
					continue;
				case 17u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._sEYqjeelWD912mJ6sF5MhQRyISf._SlotId - 1000000].Quantity ^= _50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._YnPcTOJB6UrXk2tL1AzY4w0ohpAA._SlotId - 1000000].Quantity;
					return;
				case 10u:
				{
					int num18;
					int num19;
					if (invResult._YnPcTOJB6UrXk2tL1AzY4w0ohpAA._SlotId >= 1000000)
					{
						num18 = 1230568533;
						num19 = num18;
					}
				...
				case 3u:
					b = --_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._sEYqjeelWD912mJ6sF5MhQRyISf._SlotId - 1000000].Quantity;
				...
				case 15u:
				{
					b = ++_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._YnPcTOJB6UrXk2tL1AzY4w0ohpAA._SlotId - 1000000].Quantity;
					int num16;
					int num17;
					if (b > 6)
					{
				...
				case 20u:
					_h01g85taqEzEcEAUdKYKgvZNupF(invResult._YnPcTOJB6UrXk2tL1AzY4w0ohpAA);
				...
				case 18u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._YnPcTOJB6UrXk2tL1AzY4w0ohpAA._SlotId - 1000000].Quantity = 6;
				...
				case 13u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._sEYqjeelWD912mJ6sF5MhQRyISf._SlotId - 1000000].Quantity ^= _50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._YnPcTOJB6UrXk2tL1AzY4w0ohpAA._SlotId - 1000000].Quantity;
					_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._YnPcTOJB6UrXk2tL1AzY4w0ohpAA._SlotId - 1000000].Quantity ^= _50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._sEYqjeelWD912mJ6sF5MhQRyISf._SlotId - 1000000].Quantity;
				...
				case 9u:
				{
					int num14;
					int num15;
					if (_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._sEYqjeelWD912mJ6sF5MhQRyISf._SlotId - 1000000].Quantity != _50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._YnPcTOJB6UrXk2tL1AzY4w0ohpAA._SlotId - 1000000].Quantity)
					{
						num14 = 178420240;
						num15 = num14;
					}
				...
				case 4u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invResult._sEYqjeelWD912mJ6sF5MhQRyISf._SlotId - 1000000].Type = -1;
	...
	{
		//Discarded unreachable code: IL_00b8, IL_017a, IL_02cb, IL_02f4, IL_034d, IL_03b9
		...
		goto IL_0228;
		IL_0228:
		bool flag = _50w8wVuv8bL5nhKaR2EHxjrTamB._XJlaeK8gdtamxYwZJIRc2tEXKcQA == "Vault";
		int num;
		int num2;
		if (!(slot._ObjectId == _50w8wVuv8bL5nhKaR2EHxjrTamB._itBzbWMkvo0AuQGuR19us26p4TP && flag))
		{
			num = 1140993665;
			num2 = num;
		}
		...
		while (true)
		{
			...
			default:
				return;
			case 22u:
				jI4Bueou7dItYp5S7QML5vyC6Rc = _50w8wVuv8bL5nhKaR2EHxjrTamB._VPArsrlUa0uEsW6OxAYV9WHJAMK[slot._ObjectId];
				num = 659699202;
				continue;
			case 17u:
				return;
			case 5u:
				goto IL_00ca;
			case 1u:
				_50w8wVuv8bL5nhKaR2EHxjrTamB._zGfl045ehROhk6jo6nvkc12rcvH[slot._SlotId] = slot._ObjectType;
				num = (int)(num3 * 1685156370) ^ -701094280;
				continue;
			case 9u:
				goto IL_0111;
			case 13u:
				Array.Resize(ref jI4Bueou7dItYp5S7QML5vyC6Rc.Inventory, slot._SlotId + 1);
			...
			case 6u:
				return;
			case 15u:
				_50w8wVuv8bL5nhKaR2EHxjrTamB._Pg28U1MUv2y9I7GawSrEglFuQNv[slot._SlotId] = slot._ObjectType;
				num = ((int)num3 * -737819356) ^ -702956381;
				continue;
			case 11u:
				_50w8wVuv8bL5nhKaR2EHxjrTamB._geK4oHsbAS9nZM9pjvAHYVUnwQs[slot._SlotId] = slot._ObjectType;
				num = ((int)num3 * -1472455225) ^ -1746078240;
				continue;
			case 8u:
				goto IL_01e0;
			case 23u:
				jI4Bueou7dItYp5S7QML5vyC6Rc.Inventory[slot._SlotId] = slot._ObjectType;
				num = 1987680929;
				continue;
			case 2u:
				goto IL_0228;
			case 21u:
				_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[slot._SlotId - 1000000].Type = slot._ObjectType;
			...
			case 26u:
				return;
			case 4u:
				Program._et8c2Heqb7KWtXL1gFN1nBBGIVP("client", $"Bad InvResult slot {slot}");
			...
			case 10u:
				return;
			case 24u:
				num4 = jI4Bueou7dItYp5S7QML5vyC6Rc.Inventory.Length;
				num = ((int)num3 * -1260564607) ^ 0x152D7ECE;
				continue;
			case 14u:
				goto IL_037a;
			case 12u:
				jI4Bueou7dItYp5S7QML5vyC6Rc.Inventory[num4] = -1;
				num = 1053751199;
				continue;
			case 25u:
				return;
			...
			IL_037a:
			int num7;
			if (!(slot._ObjectId == _50w8wVuv8bL5nhKaR2EHxjrTamB._29Cygi7ILPhL4sLWfXR3KEYpYle && flag))
			{
				num = 1990809147;
				num7 = num;
			}
			...
			IL_01e0:
			int num8;
			if (!(slot._ObjectId == _50w8wVuv8bL5nhKaR2EHxjrTamB._mVrHB9iWE8fKC1cy09EH2Tg38G && flag))
			{
				num = 1740231496;
				num8 = num;
			}
			...
			IL_0111:
			int num9;
			if (num4 < jI4Bueou7dItYp5S7QML5vyC6Rc.Inventory.Length)
			{
				num = 749904379;
				num9 = num;
			}
			...
			IL_029e:
			int num10;
			if (!_50w8wVuv8bL5nhKaR2EHxjrTamB._VPArsrlUa0uEsW6OxAYV9WHJAMK.ContainsKey(slot._ObjectId))
			{
				num = 308705332;
				num10 = num;
			}
			...
			IL_0155:
			int num12;
			if (slot._SlotId >= jI4Bueou7dItYp5S7QML5vyC6Rc.Inventory.Length)
			{
				num = 531855288;
				num12 = num;
			}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				default:
					return;
				case 0u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[useItem._obJo3i4uC8yf7c2aS8NBvEttXTO._SlotId - 1000000].Quantity--;
	...
	public void _YuIoQqglfhTOjnYm6YzkponW9HF(_5mDELbdDeeFjmQtnCFiDaCPaAqz invDrop)
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 0u:
					_50w8wVuv8bL5nhKaR2EHxjrTamB._nhFLD7A5r9NSgescGUZ6OSUXLbm[invDrop._GPJ1Yp8tCEXEoq8RmZNbc43WC7C._SlotId - 1000000].Quantity--;
	...
	{
		//Discarded unreachable code: IL_0119, IL_0124
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 1u:
				{
					int num5;
					int num6;
					if (!ClassStats.Map.ContainsKey(_50w8wVuv8bL5nhKaR2EHxjrTamB._W6bpBrAw6dPSILcVRK394JGD7tC._y2nCjecGeYsmqDEzaplcuBvYtN7))
					{
						num5 = -522150621;
						num6 = num5;
					}
				...
				case 18u:
					...
					continue;
				case 16u:
					classStats = ClassStats.Map[_50w8wVuv8bL5nhKaR2EHxjrTamB._W6bpBrAw6dPSILcVRK394JGD7tC._y2nCjecGeYsmqDEzaplcuBvYtN7];
				...
				case 14u:
					...
					continue;
				case 9u:
					jI4Bueou7dItYp5S7QML5vyC6Rc = _50w8wVuv8bL5nhKaR2EHxjrTamB._W6bpBrAw6dPSILcVRK394JGD7tC;
					num = 1921869604;
					continue;
				case 11u:
				{
				...
				default:
					...
					_50w8wVuv8bL5nhKaR2EHxjrTamB._TVcgSr7bcouFhNfw8PyT9bbBIM0(stringBuilder.ToString());
					return;
				}
				break;
			}
