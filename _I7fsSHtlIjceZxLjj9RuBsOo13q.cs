...
internal class _I7fsSHtlIjceZxLjj9RuBsOo13q
{
	[CompilerGenerated]
	...
	public static Dictionary<string, string> _Dy9OXVWe3aYS4Yg1G903inWJpMc
	{
		get;
		private set;
	}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				default:
				{
						...
						while (true)
						{
							...
							while (true)
							{
								...
								case 9u:
									...
									continue;
								case 17u:
									_Dy9OXVWe3aYS4Yg1G903inWJpMc.Add(xmlNode3.InnerText, xmlNode2.InnerText);
					...
					if (_Dy9OXVWe3aYS4Yg1G903inWJpMc.Count != 0)
					{
						return;
					}
					while (true)
